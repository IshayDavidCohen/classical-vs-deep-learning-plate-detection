...
**Why license plates?** License plate detection sits in a useful middle ground for this comparison. Plates have strong edges, rectangular structure, and fairly consistent visual properties, which gives classical methods a real chance. At the same time, real-world images introduce motion blur, viewpoint variation, small targets, and cluttered backgrounds, where deep learning is expected to have an advantage.
...
![HOG Feature Map Example](../outputs/images/HOG_feature_map_example.png)
...
![Linear vs RBF kernel](../outputs/GIF/SVM_Linear_vs_RBF_24_fps.gif)
...
![Linear vs RBF kernel](../outputs/GIF/SVM_C_example.gif)
...
![IoU_example](../outputs/GIF/IoU_example.gif)
...
![mAP50-95](../outputs/images/mAP50-95.png)
